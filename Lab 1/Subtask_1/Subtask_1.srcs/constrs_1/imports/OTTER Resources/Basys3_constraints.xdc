...
[DRC LUTLP-1] Combinatorial Loop Alert: 21 LUT cells form a combinatorial loop. This can create a race condition. Timing analysis may not be accurate. The preferred resolution is to modify the design to remove combinatorial logic loops. If the loop is known and understood, this DRC can be bypassed by acknowledging the condition and setting the following XDC constraint on any one of the nets in the loop: 'set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets <myHier/myNet>]'. One net in the loop is configurable_RO_inst/slice_X0Y0/LUT_F/out_signal. Please evaluate your design. The cells in the loop are: configurable_RO_inst/slice_X0Y0/buffer_stage1_inferred_i_1, configurable_RO_inst/slice_X0Y1/buffer_stage1_inferred_i_1, configurable_RO_inst/slice_X1Y0/buffer_stage1_inferred_i_1, configurable_RO_inst/slice_X1Y1/buffer_stage1_inferred_i_1, configurable_RO_inst/slice_X0Y0/buffer_stage2_inferred_i_1, configurable_RO_inst/slice_X0Y1/buffer_stage2_inferred_i_1, configurable_RO_inst/slice_X1Y0/buffer_stage2_inferred_i_1, configurable_RO_inst/slice_X1Y1/buffer_stage2_inferred_i_1, configurable_RO_inst/slice_X0Y1/LUT_F/lut_not_output_inferred_i_1, configurable_RO_inst/slice_X0Y1/LUT_G/lut_not_output_inferred_i_1, configurable_RO_inst/slice_X0Y0/out_signal[0]_INST_0, configurable_RO_inst/slice_X0Y1/out_signal[0]_INST_0, configurable_RO_inst/slice_X1Y1/out_signal[0]_INST_0, configurable_RO_inst/slice_X0Y0/LUT_F/out_signal_INST_0, configurable_RO_inst/slice_X0Y0/LUT_G/out_signal_INST_0... and (the first 15 of 21 listed).



#Ring Oscillator - Allow Comb Loops
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets configurable_RO_inst_0/slice_X0Y0/LUT_F/out_signal]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets configurable_RO_inst_1/slice_X0Y0/LUT_F/out_signal]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets configurable_RO_inst_2/slice_X0Y0/LUT_F/out_signal]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets configurable_RO_inst_3/slice_X0Y0/LUT_F/out_signal]
